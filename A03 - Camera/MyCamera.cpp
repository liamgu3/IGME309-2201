...
void Simplex::MyCamera::ResetCamera(void)
{
	...
	m_v3Above = vector3(0.0f, 1.0f, 10.0f); //What is above the camera
...
{
	vector3 forward = glm::normalize(GetTarget() - GetPosition());	//getting the forward vector
	SetPositionTargetAndUpward(m_v3Position + forward * a_fDistance, m_v3Target + forward * a_fDistance, m_v3Above - GetPosition());	//moves camera forward/backward
}

void MyCamera::MoveVertical(float a_fDistance)	//Needs to be defined
{	
	//simply moves camera up/down in worldspace
...
{
	vector3 right = glm::cross(glm::normalize(GetAbove() - GetPosition()), glm::normalize(GetTarget() - GetPosition()));	//getting the right vector
	SetPositionTargetAndUpward(m_v3Position + right * a_fDistance, m_v3Target + right * a_fDistance, (m_v3Above - GetPosition()));		//moves camera left/right
}